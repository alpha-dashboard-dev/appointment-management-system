          ...
          <div class="modal-body">
            ...
            <template v-else-if="!showRescheduleInApproval">
              ...
              <div v-else class="alert alert-warning d-flex align-items-start gap-2 mb-3">
                ...
                <div><strong>No staff available</strong> for this slot.<br>See alternative staff and slots below.</div>
              </div>
...
const approvalRescheduleForm = reactive({ appointment_start_date: '', appointment_end_date: '', start_time: '', end_time: '', location_code: '', notes: '' })
...
async function loadApprovalAvailability(appt) {
  ...
  Object.assign(approvalRescheduleForm, {
    appointment_start_date: toDateInput(appt.appointment_start_date),
    appointment_end_date: toDateInput(appt.appointment_end_date || appt.appointment_start_date),
    start_time: toTimeInput(appt.start_time),
    end_time: toTimeInput(appt.end_time),
