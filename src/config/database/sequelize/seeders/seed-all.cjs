...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        const organizationCodes = ["ORG00001"];
        const businessCodes = ["BIZ00001", "BIZ00002"];
        const userCodes = ["ADM00001", "OWN00001", "OWN00002", "STF00001", "STF00002", "STF00003", "CLU00001", "CLU00002", "CLU00003"];
        const clientCodes = ["CLU00001", "CLU00002", "CLU00003"];
        const serviceCodes = ["SVC00001", "SVC00002", "SVC00003", "SVC00004", "SVC00005"];
        const locationCodes = ["LOC00001", "LOC00002", "LOC00003"];
        const chargeCodes = ["CHG00001", "CHG00002", "CHG00003"];
        const appointmentCodes = ["APT00001", "APT00002", "APT00003", "APT00004"];

        // Allow repeated seeding runs by removing previous rows for these fixed seed codes.
        await queryInterface.bulkDelete("invoices", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("appointment_history", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("appointment_recurrence", { service_code: { [Op.in]: serviceCodes } }, {});
        await queryInterface.bulkDelete("appointment_discounts", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("appointment_charges", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("appointment_participants", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("appointment_services", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("appointments", { appointment_code: { [Op.in]: appointmentCodes } }, {});
        await queryInterface.bulkDelete("user_abilities", { user_code: { [Op.in]: userCodes } }, {});
        await queryInterface.bulkDelete("user_shift_schedules", { user_code: { [Op.in]: userCodes } }, {});
        await queryInterface.bulkDelete("charges", { charge_code: { [Op.in]: chargeCodes } }, {});
        await queryInterface.bulkDelete("location_services", {
            [Op.or]: [
                { service_code: { [Op.in]: serviceCodes } },
                { location_code: { [Op.in]: locationCodes } },
            ],
        }, {});
        await queryInterface.bulkDelete("locations", { location_code: { [Op.in]: locationCodes } }, {});
        await queryInterface.bulkDelete("services", { service_code: { [Op.in]: serviceCodes } }, {});
        await queryInterface.bulkDelete("clients", { user_code: { [Op.in]: clientCodes } }, {});
        await queryInterface.bulkDelete("businesses", { business_code: { [Op.in]: businessCodes } }, {});
        await queryInterface.bulkDelete("users", { user_code: { [Op.in]: userCodes } }, {});
        ...
        for (const day of [...weekdays, "saturday"]) {
            shiftRows.push({ business_code: "BIZ00001", user_code: "OWN00001", working_days: day, location_code: "LOC00001", start_time: "08:00:00", end_time: "18:00:00", created_at: now, updated_at: now });
        }
        for (const day of weekdays) {
            shiftRows.push({ business_code: "BIZ00001", user_code: "STF00001", working_days: day, location_code: "LOC00001", start_time: "09:00:00", end_time: "17:00:00", created_at: now, updated_at: now });
        }
        for (const day of weekdays) {
            shiftRows.push({ business_code: "BIZ00001", user_code: "STF00002", working_days: day, location_code: "LOC00001", start_time: "09:00:00", end_time: "17:00:00", created_at: now, updated_at: now });
        }
        for (const day of weekdays) {
            shiftRows.push({ business_code: "BIZ00002", user_code: "STF00003", working_days: day, location_code: "LOC00002", start_time: "08:00:00", end_time: "16:00:00", created_at: now, updated_at: now });
        }
