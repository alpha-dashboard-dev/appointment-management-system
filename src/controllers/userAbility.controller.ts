...
class UserAbilityController {
    ...
    async create(req: Request, res: Response) {
        try {
            ...
            return res.status(201).json({ success: true, message: "User ability created", data });
        } catch (err: any) {
    ...
    async update(req: Request, res: Response) {
        try {
            ...
            return res.status(200).json({ success: true, message: "User ability updated", data });
        } catch (err: any) {
            return res.status(400).json({ success: false, message: err.message });
        }
    }
    ...
    async delete(req: Request, res: Response) {
        try {
            ...
            return res.status(200).json({ success: true, message: "User ability deleted" });
        } catch (err: any) {
            return res.status(400).json({ success: false, message: err.message });
        }
    }
...
export default new UserAbilityController();
